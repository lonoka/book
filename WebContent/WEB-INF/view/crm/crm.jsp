...
<body>
	...
	<section class="ftco-section goto-here">
		<div class="container">
			...
			<div class="row" style="margin-top: 1em;">
				<div class="notice_btn" style="height: 80px; margin-bottom: 0.5rem">
					<div onclick="modifyDel()" class="btn_list"
						style="margin-left: 0.2em; margin-right: 0.2em; cursor: pointer;">회원
						탈퇴</div>
					<div onclick="modifyStat()" class="btn_list"
						style="margin-left: 0.2em; margin-right: 0.2em; cursor: pointer;">활동
						정지</div>
					<div onclick="modifyAuthor()" class="btn_list"
						style="margin-left: 0.2em; margin-right: 0.2em; cursor: pointer;">권한
						변경</div>
 ...
 %>
							...
							%>
							<li><a href="/crm.do?pgNum=<%=i%>"><%=i%></a></li>
							<%
								}
									}
								} else {
