...
<body>
		...
		<div class="container">
			...
			<div class="card shadow mb-4">
				...
				<div
					...
					<a href="/userModifyCheck.do">수정 </a>
					<a onclick="deleteUser()" style="color:saddlebrown; cursor:pointer;"> 탈퇴 </a>
					</div>
				</div>
				<!-- Card Body -->
				<div class="card-body">
	...
	function deleteUser(){
		if (confirm("탈퇴 하시겠습니까?") == true) {
			document.location.href = "/userDeleteProc.do?user_id="+"<%=uDTO.getUser_id()%>";
		} else {
			return false;
		}
	}
