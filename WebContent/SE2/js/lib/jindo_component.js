...
jindo.RolloverArea = jindo.$Class({
    ...
    _removeOvered: function(a) {
        this._aOveredElements.splice(jindo.$A(this._aOveredElements).indexOf(a), 1)
    },
...
jindo.Calendar.getRelativeDate = function(c, d, b, a) {
    return this.getDateHashTable(new Date(a.nYear + c, a.nMonth + d - 1, a.nDate + b))
};
...
jindo.LayerManager = jindo.$Class({
    ...
    fadeIn: function(b) {
        ...
        this._show(function() {
            ...
            var e = c.getLayer();
            if (!c._wel.visible() || c._wel.opacity() != 1) {
                if (c._fireEventBeforeShow()) {
                    ...
                    a.attach({
                        ...
                        "@opacity": c.option("Transition").fFadeIn.apply(null, [1])
                    })
                }
            }
        }, b);
            ...
            if (c.getVisible()) {
                ...
                if (c._fireEventBeforeHide()) {
                    ...
                    a.attach({
                        ...
                        "@opacity": c.option("Transition").fFadeOut.apply(null, [0])
                    })
                }
            }
        }, b);
            ...
            if (Math.ceil(c._wel.height()) < c._nLayerHeight) {
                if (c._fireEventBeforeShow()) {
                    if (!c.getVisible()) {
                        ...
                        d = Math.ceil(d * ((c._nLayerHeight - c._wel.height()) / (c._nLayerHeight - c._nSlideMinHeight)))
                    }
                    a.attach({
                        playing: function(f) {
                            if (f.nStep === 1) {
                        ...
                        getter: function(f) {
                            return jindo.$Element(e)[f]() + 1
                        },
                        setter: function(g, f) {
                            jindo.$Element(e)[g](parseFloat(f))
                        }
                    }, {
                        height: c.option("Transition").fSlideDown.apply(null, [c._nLayerHeight])
                    })
                }
            }
        }, b);
    ...
    slideUp: function(b) {
        ...
        this._hide(function() {
            ...
            if (c.getVisible()) {
                if (c._fireEventBeforeHide()) {
                    d = Math.ceil(d * (c._wel.height() / c._nLayerHeight));
                    a.attach({
                        end: function(f) {
                            c._wel.hide().css({
                        ...
                        getter: function(f) {
                            return jindo.$Element(e)[f]()
                        },
                        setter: function(g, f) {
                            jindo.$Element(e)[g](Math.ceil(f))
                        }
                    }, {
                        height: c.option("Transition").fSlideUp.apply(null, [c._nSlideMinHeight])
                    })
                }
            }
        }, b);
        ...
        this._oEventTimer.start(function() {
            if (!a._bIsHiding && a.getVisible()) {
                if (a._check(c)) {
                    if (!a._bIsShowing) {
                        a.fireEvent("ignore", {
                            sCheckEvent: a.option("sCheckEvent")
                        });
                        a._oHideTimer.abort();
                        a._bIsHiding = false
                    }
...
jindo.LayerPosition = jindo.$Class({
    ...
    _setLeftRight: function(i, b) {
        ...
        var a = this._isPosition(i, "left"),
            h = this._isPosition(i, "right"),
            f = this._isPosition(i, "inside");
        if (a) {
            if (f) {
                b.nLeft += i.nLeft
            } else {
    ...
    getPosition: function(m) {
        ...
        var a, j = this._isPosition(m, "center"),
            h = this._isPosition(m, "inside"),
            i = this._isPosition(m, "top"),
            s = this._isPosition(m, "bottom"),
            n = this._isPosition(m, "left"),
            c = this._isPosition(m, "right");
        if (n) {
            a = "left"
        }
        if (c) {
        ...
        d += parseInt(l.css("marginLeft")) + parseInt(l.css("marginRight")) || 0;
        e += parseInt(l.css("marginTop")) + parseInt(l.css("marginBottom")) || 0;
        switch (a) {
            case "center":
                k.nTop += (p - e) / 2;
                k.nTop += m.nTop;
    ...
    _isFullyVisible: function(c) {
        var e = this.getLayer(),
            i = jindo.$Element(e),
            g = jindo.$Document().scrollPosition(),
            h = g.top,
            b = g.left,
            a = jindo.$Document().clientSize(),
            d = e.offsetWidth + (parseInt(i.css("marginLeft")) + parseInt(i.css("marginRight")) || 0),
            f = e.offsetHeight + (parseInt(i.css("marginTop")) + parseInt(i.css("marginBottom")) || 0);
        if (c.nLeft >= 0 && c.nTop >= 0 && a.width >= c.nLeft - b + d && a.height >= c.nTop - h + f) {
            return true
        }
        return false
    },
    _mirrorHorizontal: function(c) {
        if (c.sAlign == "center" || c.sPosition == "inside-center") {
            return c
        }
        var a = {};
        for (var b in c) {
        ...
        if (this._isPosition(a, "right")) {
            ...
            if (this._isPosition(a, "left")) {
                a.sPosition = a.sPosition.replace(/left/, "right")
            } else {
                if (a.sAlign == "right") {
                    a.sAlign = "left"
                } else {
    ...
    _mirrorVertical: function(c) {
        if (c.sValign == "middle" || c.sPosition == "inside-center") {
            return c
        }
        var a = {};
        for (var b in c) {
        ...
        if (this._isPosition(a, "top")) {
            ...
            if (this._isPosition(a, "bottom")) {
                a.sPosition = a.sPosition.replace(/bottom/, "top")
            } else {
                if (a.sValign == "top") {
                    a.sValign = "bottom"
                } else {
    ...
    _adjustPosition: function(d) {
        ...
        a.push(this.getPosition(this._mirrorVertical(this._mirrorHorizontal(c))));
...
jindo.Transition = jindo.$Class({
    ...
    _doTask: function() {
        var f = this._htTaskToDo,
            c = parseFloat(f.nRatio.toFixed(5), 1),
            h = f.nStep,
            e = f.nTotalStep,
            u = f.aList,
            d = {};
                    ...
                    if (a) {
                        ...
                        if (p) {
                            ...
                            if (r == n - 1) {
                                ...
                                m = parseFloat(/(\.[0-9]+)$/.test(k) && RegExp.$1 || 0);
                                b = parseInt(k, 10) + p;
                                d[l] = m
                            }
                        }
...
(function() {
    ...
    jindo.$Element.prototype.css = function(c, b) {
        if (c == "opacity") {
            return typeof b != "undefined" ? this.opacity(parseFloat(b)) : this.opacity()
        } else {
            return typeof b != "undefined" ? a.call(this, c, b) : a.call(this, c)
        }
    }
})();
jindo.Effect = function(e) {
    ...
    var a = function(h) {
        ...
        if (c.test(h)) {
            ...
            if (d.test(h)) {
                i = [parseInt(RegExp.$1, 10), parseInt(RegExp.$2, 10), parseInt(RegExp.$3, 10)];
                g = "color"
            } else {
                if (f.test(h = h.replace(b, "#$1$1$2$2$3$3"))) {
                    i = [parseInt(RegExp.$1, 16), parseInt(RegExp.$2, 16), parseInt(RegExp.$3, 16)];
                    g = "color"
                }
            }
        }
...
jindo.FileUploader = jindo.$Class({
    ...
    _appendIframe: function() {
        ...
        this._welIframe = jindo.$Element(jindo.$('<iframe name="' + a + '" src="">')).css({
            position: "absolute",
            width: "1px",
            height: "1px",
            left: "-100px",
    ...
    upload: function() {
        ...
        var d = this.getFormElement(),
            g = jindo.$Element(d),
            e = this._welIframe.attr("name"),
            b = this._sFunctionName = e + "_func",
            a = this.option("sUrl");
        g.attr({
            target: e,
            action: a
        ...
        this.constructor._oCallback[b + "_success"] = jindo.$Fn(function(h) {
        ...
        this.constructor._oCallback[b + "_error"] = jindo.$Fn(function(h) {
            if (this.option("bAutoReset")) {
                this.reset()
            }
            this._revertFormAttr();
    ...
    _onFileSelectChange: function(b) {
        var d = b.element.value,
            a = this._checkExtension(d),
            c = {
                sValue: d,
                bAllowed: a,
...
jindo.MultipleAjaxRequest = jindo.$Class({
    ...
    _parallelRequest: function(b) {
        ...
        if (this._fireEventStart()) {
            var a = this;
            jindo.$A(this._aAjaxData).forEach(function(d, c) {
                var e = function(g) {
                    g._constructor = a._aAjax[c];
                    var f = a._findAjaxObjectIndexOfResponse(g._constructor);
                    a._aResponse[f] = g;
                    a._aStatus[f] = true;
                    if (a._fireEventAfterEachResponse(f)) {
                        if (a._hasCompletedGotResponsesOfParallelResponses()) {
                            a._complete()
                        }
                    }
                };
                a._aAjax.push(jindo.$Ajax(d.sUrl, d.htOption));
                d.htOption.onload = e;
                d.htOption.onerror = e;
                d.htOption.ontimeout = e;
                a._aAjax[c].option(d.htOption);
                if (a._fireEventBeforeEachRequest(c)) {
                    a._aAjax[c].request(d.htParameter)
                } else {
                    jindo.$A.Break()
                }
            })
        ...
        if (a > 0) {
            if (this._fireEventAfterEachResponse(a - 1)) {
                if (this._fireEventBeforeEachRequest(a)) {
                    this._aAjax[a].request(this._aAjaxData[a].htParameter)
                }
            }
        } else {
            if (a == -1) {
...
jindo.RolloverClick = jindo.$Class({
    $init: function(b, c) {
        ...
        this.option(c || {});
        var a = this;
        this._oRolloverArea = new jindo.RolloverArea(b, this.option("RolloverArea")).attach({
            over: function(d) {
...
jindo.Pagination = jindo.$Class({
        ...
        if (this.option("sMoveUnit") == "page") {
            ...
            switch (e) {
                case "pre_end":
                    ...
                    break;
                case "pre":
                    var a = (b - 1) * this.option("nPagePerPageList");
                    c = a;
                    break;
                case "next":
                    var d = (b) * this.option("nPagePerPageList") + 1;
                    c = d;
                    break;
                case "next_end":
                    c = this._getLastPage();
    ...
    _getPageList: function(c) {
        if (this.option("bAlignCenter")) {
            var a = Math.floor(this.option("nPagePerPageList") / 2);
            var b = c - a;
            b = Math.max(b, 1);
            ...
            if (this._isIn(d, e.elPrevPageLinkOn)) {
                ...
                if (this._isIn(d, e.elNextPageLinkOn)) {
                    ...
                    if (this._isIn(d, e.elLastPageLinkOn)) {
                        ...
                        if (a) {
                            b = parseInt(jindo.$Element(a).text(), 10)
                        } else {
                            return
                        }
                    }
    ...
    _paginate: function(j) {
        ...
        this._addTextNode();
        var p = this.option(),
            b = p.elFirstPageLinkOn,
            h = p.elPrevPageLinkOn,
            g = p.elNextPageLinkOn,
            n = p.elLastPageLinkOn,
            q = p.elFirstPageLinkOff,
            d = p.elPrevPageLinkOff,
            s = p.elNextPageLinkOff,
            k = p.elLastPageLinkOff,
            e = this._getLastPage(),
            r = this._getPageList(j),
            l = this._getPageList(e);
        if (e === 0) {
        ...
        for (var m = t; m <= a; m++) {
            if (m == j) {
                c = jindo.$(jindo.$Template(p.sCurrentPageTemplate).process({
                    page: m.toString()
                }))
            } else {
                c = jindo.$(jindo.$Template(p.sPageTemplate).process({
                    page: m.toString()
                }));
                this._waPage.push(c)
            }
    ...
    _empty: function() {
        var e = this.option(),
            f = e.elFirstPageLinkOn,
            d = e.elPrevPageLinkOn,
            h = e.elNextPageLinkOn,
            a = e.elLastPageLinkOn,
            b = e.elFirstPageLinkOff,
            i = e.elPrevPageLinkOff,
            c = e.elNextPageLinkOff,
            g = e.elLastPageLinkOff;
        f = this._clone(f);
        d = this._clone(d);
        a = this._clone(a);
        h = this._clone(h);
...
jindo.DatePicker = jindo.$Class({
    ...
    addDatePickerSet: function(a) {
        ...
        if (typeof a.elInput != "undefined") {
            ...
            this._wfClickLinkedElement.attach(a.elInput, "click")
        }
        if (typeof a.elButton != "undefined") {
            b.link(a.elButton);
            this._wfClickLinkedElement.attach(a.elButton, "click")
        }
    ...
    removeDatePickerSet: function(c) {
        ...
        for (var d = 0, a = this._aDatePickerSet.length; d < a; d++) {
            if (this._aDatePickerSet[d].elInput == c.elInput || this._aDatePickerSet[d].elButton == c.elButton) {
                b = d;
                break
            }
        }
        ...
        if (typeof e.elButton != "undefined") {
            f.unlink(e.elButton);
            this._wfClickLinkedElement.detach(e.elButton, "click")
        }
        if (typeof e.elInput != "undefined") {
            this._wfFocusInput.detach(e.elInput, "focus");
            this._wfClickLinkedElement.detach(e.elInput, "click");
    ...
    getDatePickerSet: function(c) {
        ...
        for (var b = 0, a = this._aDatePickerSet.length; b < a; b++) {
            if (this._aDatePickerSet[b].elInput == c || this._aDatePickerSet[b].elButton == c) {
            ...
            draw: function(b) {
                ...
                if (a.isSelectable(d, b)) {
                    ...
                    if (jindo.Calendar.isSameDate(b, d)) {
                        jindo.$Element(b.elDateContainer).addClass(c + "selected")
                    }
                } else {
                    b.bSelectable = false;
                    jindo.$Element(b.elDateContainer).addClass(this.option("sClassPrefix") + "unselectable")
                }
    ...
    _initLayerManager: function() {
        ...
        this._oLayerManager = new jindo.LayerManager(a, this.option("LayerManager")).attach({
            hide: function(c) {
    ...
    isSelectable: function(b, a) {
        return jindo.Calendar.isBetween(a, b.htOption.htSelectableDateFrom, b.htOption.htSelectableDateTo)
    },
    ...
    _getDateFormat: function(f, b) {
        ...
        d = d.replace(/yyyy/g, c).replace(/y/g, (c).toString().substr(2, 2)).replace(/mm/g, e).replace(/m/g, (e * 1)).replace(/M/g, this.getCalendar().option("aMonthTitle")[e - 1]).replace(/dd/g, a).replace(/d/g, (a * 1));
        return d
    },
    ...
    _onActivate: function() {
        var a = this.getCalendarLayer();
        this._wfMouseOverOutDate.attach(a, "mouseover").attach(a, "mouseout");
    ...
    _onDeactivate: function() {
        var a = this.getCalendarLayer();
        this._wfMouseOverOutDate.detach(a, "mouseover").detach(a, "mouseout");
        this._wfClickDate.detach(a, "click").detach(a, "mouseover").detach(a, "mouseout");
            ...
            if (d) {
                ...
                if (this.option("bUseLayerPosition")) {
                    if (typeof d.elLayerPosition != "undefined") {
                        this.getLayerPosition().setElement(d.elLayerPosition).setPosition()
                    } else {
                        this.getLayerPosition().setElement(d.elInput).setPosition()
                    }
                }
            }
        }
    ...
    _getTargetDateElement: function(b) {
        ...
        var c = (jindo.$Element(b).hasClass(a + "date")) ? b : jindo.$$.getSingle("." + a + "date", b);
        if (c && (c == b || c.length == 1)) {
            return c
        }
        return null
    ...
    _getTargetDateContainerElement: function(d) {
        ...
        if (a) {
            var b = d;
            while (!jindo.$Element(b.parentNode).hasClass(c + "week")) {
                b = b.parentNode
            }
    ...
    _onMouseOverOutDate: function(c) {
        ...
        if (b) {
            ...
            if (this._htSelectedDatePickerSet && this.isSelectable(this._htSelectedDatePickerSet, a)) {
                if (c.type == "mouseover") {
                    if (!this._elSelected) {
                        this._elSelected = jindo.$$.getSingle("." + e + "selected", this.elWeekAppendTarget);
                        if (this._elSelected) {
                            jindo.$Element(this._elSelected).removeClass(e + "selected")
                        }
                    }
    ...
    _onClickDate: function(c) {
        ...
        if (e) {
            ...
            if (b) {
                var a = this.getCalendar().getDateOfElement(b);
                if (this.isSelectable(this._htSelectedDatePickerSet, a)) {
                    this.setDate(this._htSelectedDatePickerSet, a)
                }
            }
        }
    }
...
jindo.StarRating = jindo.$Class({
    ...
    _round: function(c, i) {
        ...
        return f.toFixed(Math.max((i.toString().length - 2), 0))
    },
    _onActivate: function() {
    ...
    _onMouseMove: function(d) {
        var a = d.pos(true).offsetX + 1,
            b = (a > this._nBaseWidth) ? this._nBaseWidth : a,
            c;
        if (this.option("bSnap")) {
            c = a / this._nBaseWidth * this.option("nMaxValue");
            b = this._round(c, this.option("nStep")) * this._nBaseWidth / this.option("nMaxValue");
...
jindo.DragArea = jindo.$Class({
    ...
    _findDraggableElement: function(c) {
        if (c.nodeType === 1 && jindo.$$.test(c, "input[type=text], textarea, select")) {
            return null
        }
        var a = this;
        ...
        var b = jindo.$$.test(c, e) ? c : jindo.$$.getSingle("! " + e, c);
        if (!d(b)) {
            b = null
        }
        return b
    ...
    _onMouseMove: function(c) {
        ...
        if (n.bPrepared) {
            var l = this.option("nThreshold"),
                q = {};
            if (!n.bForceDrag && l) {
                q.nPageX = j.pageX - n.nPageX;
                q.nPageY = j.pageY - n.nPageY;
                var d = Math.sqrt(q.nPageX * q.nPageX + q.nPageY * q.nPageY);
                if (l > d) {
                    return
                }
            }
            if (this._bIE && this.option("bSetCapture")) {
                this._elSetCapture = (this._el === document) ? document.body : this._findDraggableElement(c.element);
        ...
        if (this.fireEvent("beforeDrag", a)) {
            ...
            if (this.option("bFlowOut") === false) {
                var e = a.elFlowOut,
                    m = [f.offsetWidth, f.offsetHeight],
                    b = 0,
                    h = 0;
                if (e == document.body) {
                    e = null
                }
                if (e && m[0] <= e.scrollWidth && m[1] <= e.scrollHeight) {
                    o = {
    ...
    _onSelectStart: function(a) {
        if (this.isDragging() || this._findDraggableElement(a.element)) {
            a.stop(jindo.$Event.CANCEL_DEFAULT)
        }
    }
}).extend(jindo.UIComponent);
...
jindo.NumericStepper = jindo.$Class({
    ...
    _assignHTMLElements: function() {
        ...
        this._elInput = jindo.$$.getSingle("." + a + "input", this._el);
        this._elPlusButton = jindo.$$.getSingle("." + a + "plus", this._el);
        this._elMinusButton = jindo.$$.getSingle("." + a + "minus", this._el)
    },
