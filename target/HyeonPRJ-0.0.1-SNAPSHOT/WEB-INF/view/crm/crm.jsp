...
<body>
 ...
 %>
			...
			<div class="row">
				<div class="notice_btn" style="margin-bottom: 0.5rem">
					<div onclick="modifyDel()" class="btn_list" style="margin-left: 0.2em; margin-right: 0.2em; cursor: pointer;">회원
						탈퇴</div>
					<div onclick="modifyStat()" class="btn_list" style="margin-left: 0.2em; margin-right: 0.2em; cursor: pointer;">활동
						정지</div>
					<div onclick="modifyAuthor()" class="btn_list" style="margin-left: 0.2em; margin-right: 0.2em; cursor: pointer;">권한
						변경</div>
				</div>
			</div>
			<div class="row">
